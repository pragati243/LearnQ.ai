...
//   return (
//     <div className="flex flex-col items-center">
//       {/* "Sample Text" displayed at the top */}
//       <div className="text-center mb-4 text-lg font-semibold">Sample Text</div>
...
//       {/* Wider modern question box */}
//       <div className="w-full max-w-4xl p-8 bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 shadow-lg rounded-lg transition-all duration-300">
//         <Question 
//           question={questions[currentQuestionIndex]} 
//           onAnswerSelect={handleAnswerSelect} 
//           selectedAnswer={selectedAnswers[currentQuestionIndex]} 
...
//       {/* Dynamic width question box */}
//       <div className="min-w-[300px] max-w-full p-6 bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 shadow-lg rounded-lg transition-all duration-300">
//         <Question 
//           question={questions[currentQuestionIndex]} 
//           onAnswerSelect={handleAnswerSelect} 
//           selectedAnswer={selectedAnswers[currentQuestionIndex]} 
